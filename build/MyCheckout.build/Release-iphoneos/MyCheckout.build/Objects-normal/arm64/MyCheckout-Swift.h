...
SWIFT_CLASS("_TtC10MyCheckout11AppDelegate")
...
SWIFT_CLASS("_TtC10MyCheckout14ViewController")
@interface ViewController : UIViewController
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified startCheckoutButton;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
- (void)startMPCheckout;
